...
> Compiled from `tsr02141 Encyclopedia Magica Volume One.pdf` — 20 pages
...
Most of the random artifact powers duplicate existing spells and have the same restrictions. Obviously, magical items never require material components. Spells that vary by level should operate as if cast by a 20th-level wizard or priest (within the limitations of the spell), unless otherwise noted. Powers marked in *italic boldface* are unique magic items from spells found in the *Book of Artifacts*.
...
### Table 1-01: Cataclysm (continued)

**Minor Powers (continued)**
...
| 2 | Create a permanent aura of desolation that settles over the area of effect. Individuals of good alignment are haunted by terrifying dreams and suffer −2 penalties to THAC0 and saving throws while evil creatures gain +2 penalties to the same. |
| 3 | Plants twist and wither, crops fail, and herds grow sickly. Blanket the area of effect with a blizzard, dropping temperatures to 0° F and inflicting 1d6 points of damage per hour to those unsheltered. Overland movement is impossible. The storm lasts 1d6+12 hours and snows remain 1d3 days (summer), 2d6 days (spring/fall), or 2d20 days (winter). |
...
| 16 | Create a permanent spiral of degenera- *(continued)* |
...
| Roll | Power |
|------|-------|
| 3 | Questions put to the artifact are not answered (1/week). |
